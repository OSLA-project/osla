...
1. use the search functionality [here](https://github.com/OSLA-project/osla/issues) to see if someone already filed the same issue;
...
1. [push](http://rogerdudler.github.io/git-guide/) your feature branch to (your fork of) the osla repository on GitHub;
...
1. Wait until [PyPi publish workflow](https://github.com/OSLA-project/osla/actions/workflows/publish.yml) has completed
...
1. Wait until new release is also on Bioconda (https://anaconda.org/bioconda/osla) via a automaticly created PR on [bioconda recipes repo](https://github.com/bioconda/bioconda-recipes/pulls?q=is%3Apr+is%3Aopen+osla)
1. Test osla from bioconda by manually running [Conda verify](https://github.com/OSLA-project/osla/actions/workflows/conda_verify.yml) workflow
-->
